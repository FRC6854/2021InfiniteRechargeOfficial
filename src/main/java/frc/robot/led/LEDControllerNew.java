...
public class LEDControllerNew extends SubsystemBase implements LEDMappingsNew {

    private static LEDControllerNew instance;
    ...
    public static LEDControllerNew getInstance () {
        if (instance == null){
            instance = new LEDControllerNew();
        }
        return instance;
    }
}
